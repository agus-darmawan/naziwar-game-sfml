...
BloomEffect::BloomEffect()
    ...
    , mSecondPassTextures()
{
    mShaders.load(Shaders::BrightnessPass,
                  "media/shader/Fullpass.vert",
                  "media/shader/Brightness.frag");
    mShaders.load(Shaders::DownSamplePass,
                  "media/shader/Fullpass.vert",
                  "media/shader/DownSample.frag");
    mShaders.load(Shaders::GuassianBlurPass,
                  "media/shader/Fullpass.vert",
                  "media/shader/GuassianBlur.frag");
    mShaders.load(Shaders::AddPass,
                  "media/shader/Fullpass.vert",
                  "media/shader/Add.frag");
}
